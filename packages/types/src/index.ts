...
export interface FillUp {id:string;vehicle_id:string;station_id?:string|null;occurred_at:string;fuel_type:FuelType;litres:string;pump_price_per_litre?:string;total_amount:string;odometer_km:number;full_tank:boolean;fuel_economy_l_per_100km?:string;cost_per_100km?:string;economy_is_valid:boolean;economy_warning?:string}
