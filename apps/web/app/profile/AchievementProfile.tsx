...
export default function AchievementProfile(){
  const [data,setData]=useState<Payload|null>(null); const [signedIn,setSignedIn]=useState<boolean|null>(null); const [loading,setLoading]=useState(true); const [error,setError]=useState(""); const [saving,setSaving]=useState(false); const [featured,setFeatured]=useState<string[]>([]); const [category,setCategory]=useState("ALL");
