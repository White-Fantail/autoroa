...
export default function Layout({children}:{children:React.ReactNode}){return <html lang="en-NZ"><body><ImageUploadCompatibility /><AdminStationMapNavLink /><AdminStationReportStationLink />{children}</body></html>}
