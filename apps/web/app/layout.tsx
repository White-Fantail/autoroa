...
import AdminPathRoutingCompatibility from './components/AdminPathRoutingCompatibility';
import AdminDetailPathCompatibility from './components/AdminDetailPathCompatibility';
...
export default function Layout({children}:{children:React.ReactNode}){return <html lang="en-NZ"><body><AdminPathRoutingCompatibility /><AdminDetailPathCompatibility /><ImageUploadCompatibility /><AdminStationMapNavLink /><AdminStationReportStationLink /><AdminUserModerationControls /><AdminAchievementNavLink /><AchievementCelebration />{children}</body></html>}
