...
export default function Layout({children}:{children:React.ReactNode}){return <html lang="en-NZ"><body><ImageUploadCompatibility /><AdminStationMapNavLink />{children}</body></html>}
