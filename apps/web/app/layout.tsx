...
export default function Layout({children}:{children:React.ReactNode}){return <html lang="en-NZ"><body><AdminPathRoutingCompatibility /><ImageUploadCompatibility /><AdminStationMapNavLink /><AdminStationReportStationLink /><AdminUserModerationControls /><AdminAchievementNavLink /><AchievementCelebration />{children}</body></html>}
