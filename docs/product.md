...
Autoroa's primary value exchange is: scan receipt and odometer, confirm uncertain fields, receive accurate spend/economy history, and contribute minimal pseudonymous price evidence. Private provenance remains internally linked for audit and deletion but is never included in public price responses. The review step is never skipped. Confidence bands are high (≥.90), medium (.70–.899), and attention required (<.70).
